...
<article id="post-<?php the_ID(); ?>" <?php post_class('contact-page'); ?>>
	...
	<div class="container">
		...
		<div class="entry-content content-page parallax_one_contact_form">
			...
			<?php
				$llorix_one_contact_form_shortcode = get_theme_mod('parallax_one_contact_form_shortcode');
			?>
			<div class="col-md-6">
				<?php the_content(); ?>
			</div>
		...
		<?php 
			$llorix_one_contact_map_shortcode = get_theme_mod('parallax_one_contact_map_shortcode');
