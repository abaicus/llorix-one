...
function llorix_one_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'llorix_one_sections_order' , array(
		'title'       => __( 'Sections management', 'llorix-one' ),
		'priority' => 20
	));
	
	$wp_customize->add_setting( 'llorix_one_sections_management', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_sections_management', array(
		'label'    => __( 'Sections management', 'llorix-one' ),
		'section' => 'llorix_one_sections_order',
		'priority' => 1,
		'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the frontpage SECTIONS ORDER!', 'llorix-one' )
    )));
	
	
	
	
	$wp_customize->add_section( 'llorix_one_features_ribbon_section' , array(
		'title'       => esc_html__( 'Features ribbon section', 'llorix-one' ),
		'priority'    => 46,
	));
	
	$wp_customize->add_setting( 'llorix_one_features_ribbon_text', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_features_ribbon_text',
		array(
			'label'    => __( 'Features ribbon', 'llorix-one' ),
			'section' => 'llorix_one_features_ribbon_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW FEATURES RIBBON SECTION!', 'llorix-one' )
	   )
	));
	
	
	$wp_customize->add_section( 'llorix_one_shop_section' , array(
			'title'       => esc_html__( 'Shop section', 'llorix-one' ),
			'priority'    => 47,
	));
	
	$wp_customize->add_setting( 'llorix_one_shop_text', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_shop_text',
		array(
			'label'    => __( 'Shop', 'llorix-one' ),
			'section' => 'llorix_one_shop_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW SHOP SECTION!', 'llorix-one' )
	   )
	));
	...
	$wp_customize->add_section( 'llorix_one_portfolio_section' , array(
		'title'       => esc_html__( 'Portfolio section', 'llorix-one' ),
		'priority'    => 48,
	));
	
	$wp_customize->add_setting( 'llorix_one_portfolio_text', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_portfolio_text',
		array(
			'label'    => __( 'Portfolio', 'llorix-one' ),
			'section' => 'llorix_one_portfolio_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW PORTFOLIO SECTION!', 'llorix-one' )
	   )
	));
	...
	$wp_customize->add_section( 'llorix_one_shortcodes_section' , array(
		'title'       => esc_html__( 'Shortcodes section', 'llorix-one' ),
		'priority'    => 61,
	));
	
	$wp_customize->add_setting( 'llorix_one_shortcodes_text', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_shortcodes_text',
		array(
			'label'    => __( 'Shortcodes', 'llorix-one' ),
			'section' => 'llorix_one_shortcodes_section',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the NEW SHORTCODES SECTION!', 'llorix-one' )
	   )
	));	
	
	
	
	$wp_customize->add_section( 'llorix_one_new_features' , array(
		'title'       => esc_html__( 'New Features', 'llorix-one' ),
		'priority'    => 76,
	));
	
	$wp_customize->add_setting( 'llorix_one_new_layout', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_new_layout',
		array(
			'label'    => __( 'Header Layout', 'llorix-one' ),
			'section' => 'llorix_one_new_features',
			'priority' => 1,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the HEADER\'S LAYOUT SECTION!', 'llorix-one' )
	   )
	));	
	
	
	$wp_customize->add_setting( 'llorix_one_new_color', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_new_color',
		array(
			'label'    => __( 'Color scheme', 'llorix-one' ),
			'section' => 'llorix_one_new_features',
			'priority' => 2,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the COLOR SCHEME!', 'llorix-one' )
	   )
	));
	
	
	$wp_customize->add_setting( 'llorix_one_new_preloader', array(
			'sanitize_callback' => 'llorix_one_sanitize_text',
	) );
	
	$wp_customize->add_control( new Llorix_One_Message( $wp_customize, 'llorix_one_new_preloader',
		array(
			'label'    => __( 'Preloader', 'llorix-one' ),
			'section' => 'llorix_one_new_features',
			'priority' => 2,
			'parallax_message' => __( 'Check out the <a href="http://themeisle.com/plugins/parallax-one-plus/">PRO version</a> for full control over the PRELOADER IMAGE!', 'llorix-one' )
	   )
	));	
