...
$parallax_one = wp_get_theme( 'llorix-one' );
...
<div class="parallax-one-tab-pane" id="changelog">
	...
	<div class="prallax-one-tab-pane-center">
		...
		<h1>Llorix One <?php if( !empty($parallax_one['Version']) ): ?> <sup id="parallax-one-theme-version"><?php echo esc_attr( $parallax_one['Version'] ); ?> </sup><?php endif; ?></h1>
