...
<?php
	global $wp_customize;
	$parallax_one_our_services_title = get_theme_mod('parallax_one_our_services_title',esc_html__('Our Services','llorix-one'));
	$parallax_one_our_services_subtitle = get_theme_mod('parallax_one_our_services_subtitle',esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.','llorix-one'));
													...
													if( !empty($parallax_one_service_box->image_url)){
														if( !empty($parallax_one_service_box->link) ){
															if(!empty($parallax_one_service_box->title)){
																...
																echo '<a href="'.esc_url($parallax_one_service_box->link).'"><img src="'.esc_url($parallax_one_service_box->image_url).'" alt="'.esc_html__('Featured Image','llorix-one').'"/></a>';
															}
														} else {
															if(!empty($parallax_one_service_box->title)){
																echo '<img src="'.esc_url($parallax_one_service_box->image_url).'" alt="'.$parallax_one_service_box->title.'"/>';
															} else {
																echo '<img src="'.esc_url($parallax_one_service_box->image_url).'" alt="'.esc_html__('Featured Image','llorix-one').'"/>';
															}
														}
													}
												}
