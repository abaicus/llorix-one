...
<?php
	global $wp_customize;
	$parallax_one_our_team_title = get_theme_mod('parallax_one_our_team_title',esc_html__('Our Team','llorix-one'));
	$parallax_one_our_team_subtitle = get_theme_mod('parallax_one_our_team_subtitle',esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.','llorix-one'));
												...
												<?php
													if( !empty($parallax_one_team_member->image_url)){
														if( !empty($parallax_one_team_member->title) ){
															...
															echo '<img src="'.esc_url($parallax_one_team_member->image_url).'" alt="'.esc_html__('Avatar','llorix-one').'">';
														}
													} else {
...
?>
			<section class="team paralax_one_only_customizer" id="team" role="region" aria-label="<?php esc_html_e('Team','llorix-one') ?>">
				<div class="section-overlay-layer">
					<div class="container">
						<div class="section-header">
