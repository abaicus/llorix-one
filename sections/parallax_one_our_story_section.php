...
<?php
	...
	$parallax_one_our_story_title = get_theme_mod('parallax_one_our_story_title',esc_html__('Our Story','llorix-one'));
...
?>
			<section class="brief text-left brief-design-one brief-left paralax_one_only_customizer" id="story" role="region" aria-label="<?php esc_html_e('About','llorix-one') ?>">
