						...
						<?php
							...
							if( !empty($llorix_one_button_text) ){
								if( empty($llorix_one_button_link) ){
									echo '<button class="btn btn-primary standard-button paralax_one_only_customizer" type="button" data-toggle="modal" data-target="#stamp-modal"><span class="screen-reader-text">'.esc_html__('Ribbon button label:','llorix-one').$llorix_one_button_text.'</span>'.$llorix_one_button_text.'</button>';
								} else {
