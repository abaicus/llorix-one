				...
				if(!empty($parallax_one_logo->image_url)){
					...
					if(!empty($parallax_one_logo->link)){
						echo '<a href="'.$parallax_one_logo->link.'" title="">';
							echo '<img src="'.$parallax_one_logo->image_url.'" alt="'. esc_html__('Logo','llorix-one') .'">';
						echo '</a>';
					} else {
						echo '<img src="'.esc_url($parallax_one_logo->image_url).'" alt="'.esc_html__('Logo','llorix-one').'">';
					}
					echo '</li>';
