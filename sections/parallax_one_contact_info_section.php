...
============================== -->
<?php
	$llorix_one_contact_info_item = get_theme_mod('parallax_one_contact_info_content',
		json_encode(
			array( 
										...
										foreach($llorix_one_contact_info_item_decoded as $llorix_one_contact_item){
											if(!empty($llorix_one_contact_item->link)){
												...
												if(!empty($llorix_one_contact_item->text)){
													echo '<a href="'.$llorix_one_contact_item->link.'" class="strong">'.$llorix_one_contact_item->text.'</a>';
												}
												echo '</div>';
											} else {
